...
#include "kLowReNikuradseWallFunctionFvPatchScalarField.H"
...
void kLowReNikuradseWallFunctionFvPatchScalarField::checkType()
{
...
scalar kLowReNikuradseWallFunctionFvPatchScalarField::yPlusLam
(
    const scalar kappa,
    const scalar E
)
...
kLowReNikuradseWallFunctionFvPatchScalarField::kLowReNikuradseWallFunctionFvPatchScalarField
(
    const fvPatch& p,
...
kLowReNikuradseWallFunctionFvPatchScalarField::kLowReNikuradseWallFunctionFvPatchScalarField
(
    const kLowReNikuradseWallFunctionFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
kLowReNikuradseWallFunctionFvPatchScalarField::kLowReNikuradseWallFunctionFvPatchScalarField
(
    const kLowReNikuradseWallFunctionFvPatchScalarField& kwfpsf
)
    :
...
void kLowReNikuradseWallFunctionFvPatchScalarField::updateCoeffs()
{
    if (updated()) {
        return;
    }
    ...
    forAll(kw, facei) {
        ...
        if (ustar > ROOTVSMALL) {
            ...
            // Eq. 24 in Aupooix (2016)
            scalar kPlus = (1.0/sqrt(Betak_))
                *tanh(((log(krPlus/30.0)/log(8.0)) 
                + 0.5*(1.0 - tanh(krPlus/100.0)))*tanh(krPlus/75.0));
...
void kLowReNikuradseWallFunctionFvPatchScalarField::evaluate
(
...
void kLowReNikuradseWallFunctionFvPatchScalarField::write(Ostream& os) const
{
