...
#include "omegaWilcoxWallFunctionFvPatchScalarField.H"
...
scalar omegaWilcoxWallFunctionFvPatchScalarField::tolerance_ = 1e-5;

// * * * * * * * * * * * * Protected Member Functions  * * * * * * * * * * * //

void omegaWilcoxWallFunctionFvPatchScalarField::checkType()
{
...
void omegaWilcoxWallFunctionFvPatchScalarField::writeLocalEntries(Ostream& os) const
{
...
void omegaWilcoxWallFunctionFvPatchScalarField::setMaster()
{
    if (master_ != -1) {
        return;
    }
    ...
    label master = -1;
    forAll(bf, patchi) {
        if (isA<omegaWilcoxWallFunctionFvPatchScalarField>(bf[patchi])) {
            omegaWilcoxWallFunctionFvPatchScalarField& opf = omegaPatch(patchi);
...
void omegaWilcoxWallFunctionFvPatchScalarField::createAveragingWeights()
{
    const volScalarField& omega =
        static_cast<const volScalarField&>(this->internalField());
...
omegaWilcoxWallFunctionFvPatchScalarField&
omegaWilcoxWallFunctionFvPatchScalarField::omegaPatch(const label patchi)
{
    const volScalarField& omega =
        static_cast<const volScalarField&>(this->internalField());
    ...
    const omegaWilcoxWallFunctionFvPatchScalarField& opf =
        refCast<const omegaWilcoxWallFunctionFvPatchScalarField>(bf[patchi]);

    return const_cast<omegaWilcoxWallFunctionFvPatchScalarField&>(opf);
}


void omegaWilcoxWallFunctionFvPatchScalarField::calculateTurbulenceFields
(
...
void omegaWilcoxWallFunctionFvPatchScalarField::calculate
(
    const turbulenceModel& turbModel,
...
)
{
    ...
    forAll(nutw, facei) {
        ...
        if (krPlus < 1.5) {
            ...
            // Value for krPlus <= 5
            // E.q. 8 - Fuhrman et al (2010)
            scalar Sr = sqr(200./krPlus);
            if (krPlus > 5)
            {
                // Const from Fuhrman et al (2010).
                scalar Kr = 180.;
                // E.q. 8 - Fuhrman et al (2010)
                Sr = (Kr/krPlus) + (Sr - Kr/krPlus)*exp(5. - krPlus);
            }
            // E.q. 7 - Fuhrman et al (2010)
            omega0[celli] = Sr*sqr(ustar)/nuw[facei];
        }
    }
}
...
omegaWilcoxWallFunctionFvPatchScalarField::omegaWilcoxWallFunctionFvPatchScalarField
(
    const fvPatch& p,
...
omegaWilcoxWallFunctionFvPatchScalarField::omegaWilcoxWallFunctionFvPatchScalarField
(
    const omegaWilcoxWallFunctionFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
omegaWilcoxWallFunctionFvPatchScalarField::omegaWilcoxWallFunctionFvPatchScalarField
(
    const omegaWilcoxWallFunctionFvPatchScalarField& owfpsf
)
    :
...
scalarField& omegaWilcoxWallFunctionFvPatchScalarField::G(bool init)
{
...
scalarField& omegaWilcoxWallFunctionFvPatchScalarField::omega(bool init)
{
    if (patch().index() == master_) {
        if (init) {
            omega_ = 0.0;
...
void omegaWilcoxWallFunctionFvPatchScalarField::updateCoeffs()
{
    if (updated()) {
        return;
    }
...
void omegaWilcoxWallFunctionFvPatchScalarField::updateWeightedCoeffs
(
...
void omegaWilcoxWallFunctionFvPatchScalarField::manipulateMatrix
(
...
void omegaWilcoxWallFunctionFvPatchScalarField::write(Ostream& os) const
{
