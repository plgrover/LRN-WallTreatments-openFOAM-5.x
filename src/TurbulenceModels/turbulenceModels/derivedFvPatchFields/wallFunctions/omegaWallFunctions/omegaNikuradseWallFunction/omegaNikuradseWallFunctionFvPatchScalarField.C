...
#include "omegaNikuradseWallFunctionFvPatchScalarField.H"
...
scalar omegaNikuradseWallFunctionFvPatchScalarField::tolerance_ = 1e-5;

// * * * * * * * * * * * * Protected Member Functions  * * * * * * * * * * * //

void omegaNikuradseWallFunctionFvPatchScalarField::checkType()
{
...
void omegaNikuradseWallFunctionFvPatchScalarField::writeLocalEntries(Ostream& os) const
{
...
void omegaNikuradseWallFunctionFvPatchScalarField::setMaster()
{
    if (master_ != -1) {
        return;
    }
    ...
    label master = -1;
    forAll(bf, patchi) {
        if (isA<omegaNikuradseWallFunctionFvPatchScalarField>(bf[patchi])) {
            omegaNikuradseWallFunctionFvPatchScalarField& opf = omegaPatch(patchi);
...
void omegaNikuradseWallFunctionFvPatchScalarField::createAveragingWeights()
{
    const volScalarField& omega =
        static_cast<const volScalarField&>(this->internalField());
...
omegaNikuradseWallFunctionFvPatchScalarField::omegaPatch(const label patchi)
{
    const volScalarField& omega =
        static_cast<const volScalarField&>(this->internalField());
    ...
    const omegaNikuradseWallFunctionFvPatchScalarField& opf =
        refCast<const omegaNikuradseWallFunctionFvPatchScalarField>(bf[patchi]);

    return const_cast<omegaNikuradseWallFunctionFvPatchScalarField&>(opf);
}


void omegaNikuradseWallFunctionFvPatchScalarField::calculateTurbulenceFields
(
...
void omegaNikuradseWallFunctionFvPatchScalarField::calculate
(
    const turbulenceModel& turbModel,
...
omegaNikuradseWallFunctionFvPatchScalarField::omegaNikuradseWallFunctionFvPatchScalarField
(
    const fvPatch& p,
...
omegaNikuradseWallFunctionFvPatchScalarField::omegaNikuradseWallFunctionFvPatchScalarField
(
    const omegaNikuradseWallFunctionFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
omegaNikuradseWallFunctionFvPatchScalarField::omegaNikuradseWallFunctionFvPatchScalarField
(
    const omegaNikuradseWallFunctionFvPatchScalarField& owfpsf
)
    :
...
scalarField& omegaNikuradseWallFunctionFvPatchScalarField::G(bool init)
{
...
scalarField& omegaNikuradseWallFunctionFvPatchScalarField::omega(bool init)
{
    if (patch().index() == master_) {
        if (init) {
            omega_ = 0.0;
...
void omegaNikuradseWallFunctionFvPatchScalarField::updateCoeffs()
{
    if (updated()) {
        return;
    }
...
void omegaNikuradseWallFunctionFvPatchScalarField::updateWeightedCoeffs
(
...
void omegaNikuradseWallFunctionFvPatchScalarField::manipulateMatrix
(
...
void omegaNikuradseWallFunctionFvPatchScalarField::write(Ostream& os) const
{
